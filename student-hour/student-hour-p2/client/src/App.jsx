...
function ProtectedRoute({ children, role }) {
  ...
  if (loading) return (
    <div style={{
      ...
      fontFamily: 'var(--font-sans)', color: 'var(--text-muted)', fontSize: 15
    }}>
      Loading...
    </div>
  )
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dashboard/nova" element={
          <ProtectedRoute role="student"><ProfessorNovaPage /></ProtectedRoute>
        } />
